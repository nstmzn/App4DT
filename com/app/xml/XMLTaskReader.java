...
public class XMLTaskReader {
	...
	public static void main(String[] args)throws Exception {
		...
		String xmlPath = "." + File.separator + "properties"+ File.separator + "app.xml";
		List<TaskVO> list = o.read(".\\properties\\app.xml");
...
//						log.debug("---@!@--- " + node.getNodeName()); 
						...
						if (node.getNodeType() == Node.ELEMENT_NODE) {
							...
							if (node.getNodeName().equalsIgnoreCase("incoming-excel")) {
								vo.setExcelPath(getChildElementValueByTagName(parentElement, "path"));
								vo.setExcelFileName(getChildElementValueByTagName(parentElement, "file-name"));
								vo.setExcelColumns(getChildElementValueByTagName(parentElement, "columns"));

							}else if (node.getNodeName().equalsIgnoreCase("database")) {
								
								/*  not supposed to add database credentials in configuration file
								    vo.setDbURL(getChildElementValueByTagName(parentElement, "url"));
									vo.setDbUserName(getChildElementValueByTagName(parentElement, "username"));
									vo.setDbPassword(getChildElementValueByTagName(parentElement, "password"));
								*/
